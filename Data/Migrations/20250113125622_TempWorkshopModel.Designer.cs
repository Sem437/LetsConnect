...
namespace LetsConnect.Data.Migrations
{
    ...
    [Migration("20250113125622_TempWorkshopModel")]
    partial class TempWorkshopModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LetsConnect.Models.StudentModel", b =>
                {
            ...
            modelBuilder.Entity("LetsConnect.Models.TemporaryWorkshopRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConformationToken")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TemporaryWorkshopRegistrations");
                });

            modelBuilder.Entity("LetsConnect.Models.WorkshopModel", b =>
                {
                    b.Property<int>("WorkshopId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WorkshopIMG")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("WorkshopMax")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WorkshopSignUps")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LetsConnect.Models.WorkshopStudents", b =>
                {
                    b.Property<int>("IdStudentWorkshop")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdStudentWorkshop"));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LetsConnect.Models.StudentModel", null)
                        .WithMany()
